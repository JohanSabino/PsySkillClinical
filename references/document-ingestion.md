...
Pide al profesional que copie los archivos autorizados a una carpeta `inputs/` dentro del proyecto o que pegue rutas locales concretas. Enumera primero los candidatos y espera confirmación del conjunto. No recorras el disco completo ni incluyas archivos ocultos, temporales o no seleccionados.
